...
public class ControlSystem {
    ...
    private final Map<Integer, AmplifierType> availableSpecialAmplifiers = Map.of(
    ...
    {
        return new BestMagicalPerformancePowerUnitFactory(magicStable.getAllReindeers(),
                availableSpecialAmplifiers).bringAllReindeers();
    }
